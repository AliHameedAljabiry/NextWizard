...
const AuthForm = <T extends FieldValues> ({type, schema, defaultValues, onSubmit}: Props<T>) => {
    ...
    return (
        <div className="flex flex-col gap-4">
                                ...
                                <FormItem>
                                    {field.name === "terms" ? (
                                        <div className="flex items-center gap-2">
                                            ...
                                            <FormLabel htmlFor="terms" className="text-sm text-gray-300">
                                                I accept the&nbsp;
                                                <Link href="/terms" target="_blank" className="underline text-primary"> terms and conditions </Link>
                                            </FormLabel>
                                        </div>
                                    ) : (
                                        <>
            ...
            <p className="text-center text-base font-medium flex flex-row items-center justify-between gap-2">
                <span>{isSignIn ? <Link href="/forgot-password" className="font-bold text-primary">Forgot your password?</Link>: "Already have an account? "}</span>
            ...
            {isSignIn && (<div className="flex flex-col items-center justify-center gap-2 w-full  space-y-4 mt-7">
                ...
                <Button 
                    ...
                    className=" text-black h-[55px] text-lg  bg-inherit flex flex-row gap-2 items-center justify-center w-full bg-white p-2 rounded-md" 
